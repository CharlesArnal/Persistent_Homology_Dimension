...
plot_crit_points.py defines a function that plots in 3D the centers of the (smallest) circumsphere of the critical simplices of a given dimension of the alpha filtration of a points cloud in R³

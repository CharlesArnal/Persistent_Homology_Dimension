...
from basic_functions import compute_alpha_complex
...
def number_of_intervals(simplex_tree_with_computed_persistence, homology_degree : int, min_len_intervals = 1e-10, min_birth_value = 0.3, essential_part_included = False):
...
def mean_and_std_of_intervals_lengths(simplex_tree_with_computed_persistence, homology_degree : int, min_len_intervals = 1e-10, min_birth_value = 0.3, essential_part_included = False):
    relevant_pairs = get_critical_pairs(simplex_tree_with_computed_persistence, homology_degree, min_len_intervals, min_birth_value, essential_part_included)
    lengths = np.array(get_lengths_intervals(relevant_pairs))

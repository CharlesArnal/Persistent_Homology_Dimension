...
from persistence_computations import  plot_diagrams, number_of_intervals, mean_and_std_of_intervals_lengths
...
if experiment_number == 1:
    ...
    for N in number_of_points:
        X = points_on_J_T_parabolas_example(N, 0.5)
    ...
    for N in number_of_points+[2000]:
        X = points_on_regular_grid_on_parallel_cubes_in_RD(N,2,3,length = 2)
